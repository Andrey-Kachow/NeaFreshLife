...
# def try_to_sovle(A, b):
#     try:  # attempt to sovle equation Ar = b, where r is a column of unknown servings
#         r = linalg.solve(A, b)
#         # converting 4x1 matrix to list with 4 numbers
#         r = r.tolist()
#         print("I solved the equation", r)
#         new_r = []
#         for item in r:
#             new_r.append(item[0])  # for example:   [5.0] ----> 5.0
#         r = new_r
#         print("I converted matrix to list", r)
#     except linalg.LinAlgError as err:  # occurs when A is singular matrix
#         print("OOPS! NO SOLUTION")
#         r = [-1, -1, -1, -1]  # negative servings are unacceptable
#     return r
...
#     [carbs],
#     [fats],
#     [20],  # healthscore must be 20
# ])
# r = try_to_solve(A, b)
# # if no sollution or sollution has negatve servings
# if r[0] < 0 or r[1] < 0 or r[2] < 0 or r[3] < 0:
#     # finding least squares approximation of the sollution
#     print("I am going to find LEAST SQUARES sollution")
#     At = A.transpose()
#     A = At * A  # matrix multiplication
#     b = At * b
#     r = try_to_sovle(A, b)  # solving AtAr* = Atb

# "range_m": range(meal_num),  # range of meals in plan
# "range_f": range(3 + bool(Other)),  # range() of 3 or 4  # range of food in meal

# while not solved and sollution_can_show_up:
#     while_loop_counter += 1
#     Main = Main_choices[randint(0, len(Main_choices) - 1)]  # taking random item from each category
#     Side = Side_choices[randint(0, len(Side_choices) - 1)]
#     Veg = Veg_choices[randint(0, len(Veg_choices) - 1)]
# 
#     if Other_choices:  # Solving with "Other"
#         Other = Other_choices[randint(0, len(Other_choices) - 1)]
...
#     else:
#         Other_p = Other_f = Other_c = Other_h = Other_kcal = 0
# 
#     # Solving with "Other"
#     A = array([  # content of nutrients in food
#         [Main.protein, Side.protein, Veg.protein, Other_p],
...
#         [Main.calories, Side.calories, Veg.calories, Other_kcal],
#     ])
#     b = array([  # reauirements column vector
#         prots,
#         carbs,
#         fats,
#         healthscore_constraint,
#         calories,
#     ])  # 20 is required value for healthscore during a day
# 
#     r = lsq_linear(A, b, bounds=(0.4, 6)).x.tolist()
#     # r = nnls(A, b)[0].tolist()  # Non Negative Least Squares approximation
#     print("r =", r)
#     Main_s = r[0]
#     Side_s = r[1]
#     Veg_s = r[2]
#     Other_s = r[3]
# 
#     # Difference in between the expected and actual values
#     cal_err = Main.calories * Main_s + Side.calories * Side_s + \
#               Veg.calories * Veg_s + Other_kcal * Other_s - calories
# 
#     pro_err = Main.protein * Main_s + Side.protein * Side_s + \
#               Veg.protein * Veg_s + Other_p * Other_s - prots
# 
#     fat_err = Main.fat * Main_s + Side.fat * Side_s + \
#               Veg.fat * Veg_s + Other_f * Other_s - fats
# 
#     car_err = Main.carbs * Main_s + Side.carbs * Side_s + \
#               Veg.carbs * Veg_s + Other_c * Other_s - carbs
# 
#     hls_err = Main.healthscore * Main_s + Side.healthscore * Side_s + \
#               Veg.healthscore * Veg_s + Other_h * Other_s - healthscore_constraint
# 
#     print("cal_err --->", cal_err)
#     print("pro_err --->", pro_err)
#     print("fat_err --->", fat_err)
...
#     ):
#         solved = True
#         Other_s = int(Other_s * 100)
#     if while_loop_counter > 999:
#         sollution_can_show_up = False
# print("I tried", while_loop_counter, "times!!!!!!!!")
# if not sollution_can_show_up:
#     print("BLEAT")
